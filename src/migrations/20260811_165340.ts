...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_inquiries_service" AS ENUM('web', 'cad', 'billing', 'other');
  CREATE TYPE "public"."enum_inquiries_status" AS ENUM('new', 'pending', 'converted', 'closed');
  CREATE TYPE "public"."enum_projects_status" AS ENUM('progress', 'completed');
  ...
  CREATE TYPE "public"."enum_quotations_status" AS ENUM('draft', 'sent', 'approved', 'rejected');
  ...
  CREATE TABLE "inquiries" (
  	...
  	"service" "enum_inquiries_service" NOT NULL,
  ...
  CREATE TABLE "quotations" (
  	...
  	"status" "enum_quotations_status" DEFAULT 'sent',
  ...
  ALTER TABLE "projects" ADD CONSTRAINT "projects_client_id_inquiries_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."inquiries"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "quotations" ADD CONSTRAINT "quotations_document_file_id_media_id_fk" FOREIGN KEY ("document_file_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "redirects_rels" ADD CONSTRAINT "redirects_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."redirects"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "redirects_rels" ADD CONSTRAINT "redirects_rels_inquiries_fk" FOREIGN KEY ("inquiries_id") REFERENCES "public"."inquiries"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "quotations_document_file_idx" ON "quotations" USING btree ("document_file_id");
  ...
  CREATE INDEX "redirects_rels_inquiries_id_idx" ON "redirects_rels" USING btree ("inquiries_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_inquiries_service";
